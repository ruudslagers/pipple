        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <nav class="navbar-custom">
                    <img src="assets/logo/3.jpg" class="logo-philips">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one voortgang">
                                    ...
                                    <p class="font-600 m-b-5">Dash Tag <span class="text-success float-right"><b>25%</b></span></p>
                                    <div class="progress" style="height: 20px;">
                                        <div class="progress-bar progress-bar-striped bg-success philips" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <a href="#">
                                                    <div class="link">
