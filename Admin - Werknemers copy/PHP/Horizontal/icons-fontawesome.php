                        ...
                        <div>
                            <div class="card-box">
                                ...
                                <section id="spinner">
                                    ...
                                    <div class="row icon-list-demo">
                                        <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-spin fa-circle-o-notch" style="width: auto;margin-right: 10px;"></i> fa-circle-o-notch</div>

                                        <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-spin fa-cog" style="width: auto;margin-right: 10px;"></i> fa-cog</div>

                                        <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-spin fa-gear" style="width: auto;margin-right: 10px;"></i> fa-gear <span class="text-muted">(alias)</span>
                                        </div>

                                        <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-spin fa-refresh" style="width: auto;margin-right: 10px;"></i> fa-refresh</div>

                                        <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-spin fa-spinner" style="width: auto;margin-right: 10px;"></i> fa-spinner</div>
